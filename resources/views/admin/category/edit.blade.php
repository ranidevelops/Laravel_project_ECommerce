								...
								<div class="row">
									...
									<div class="col-md-6">
                                      ...
                                      @if(!empty($category->image))
                                        <div>
                                            <img width="250" src="{{ asset('uploads/category/thumb/'.$category->image) }}" alt="Image is not present." onerror="this.onerror=null;this.src='{{ asset('path/to/placeholder.jpg') }}';">
                                        </div>
                                     @else
									...
									<div class="col-md-6">
										<div class="mb-3">
											...
											<select  name="showHome" id="showHome" class="form-control" placeholder="select status">
